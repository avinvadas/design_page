...
}).setClassToggle("#section_heading-about", "section__heading--reveal").triggerHook("onEnter").addTo(controller);
var scene_heading_testimonials = new ScrollMagic.Scene({
...
var scene_button_email = new ScrollMagic.Scene({
  ...
  reverse: true
}).setClassToggle("#nav__button_email", "nav_icon--revealed").triggerHook("onLeave").addTo(controller);
/*#nav__button_email*/
